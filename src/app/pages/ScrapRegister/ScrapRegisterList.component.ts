...
@Component({
  selector: 'app-ScrapRegisterList',
  templateUrl: './ScrapRegisterList.component.html',
})
  @Pipe({
...
export class ScrapRegisterListComponent implements OnInit {
  ...
  submit(input: scrapsearchmodel) {
    this.paService.getscraplistbysearch(input).subscribe(data => {
